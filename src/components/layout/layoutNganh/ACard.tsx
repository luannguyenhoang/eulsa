  ...
  const listData = [
    {
      ...
      desc:
        section?.section?.list_4?.list_1?.label_1 ||
    ...
    },
    {
      ...
      desc:
        section?.section?.list_4?.list_2?.label_1 ||
        "Thời gian học chỉ từ 2 - 2,5 năm",
    ...
    },
    {
      ...
      desc:
        section?.section?.list_4?.list_3?.label_1 ||
        "Thời gian học chỉ từ 2 - 2,5 năm",
    ...
    },
    {
      ...
      desc:
        section?.section?.list_4?.list_4?.label_1 ||
        "Thời gian học chỉ từ 2 - 2,5 năm",
      ...
      <div className="container max-w-7xl mx-auto text-white py-12 px-6 md:px-20 flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2 grid grid-cols-2 gap-4">
          {listData.map((item, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-lg shadow-lg text-[#1657A7] text-center"
            >
