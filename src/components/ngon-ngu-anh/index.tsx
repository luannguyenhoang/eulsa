  ...
  return (
    <>
      ...
      <Layout title={section?.list_2?.title || "Tại sao nên học Ngôn ngữ Anh - Trường Đại học Lao động - Xã hội"}>
        <Card title={section?.list_2?.title_1 ||"MỨC LƯƠNG HẤP DẪN"}>
        ...
        <Card title={section?.list_2?.title_2 ||"NGÔN NGỮ TOÀN CẦU"}>
        ...
        <Card title={section?.list_2?.title_3 ||"PHÁT TRIỂN BẢN THÂN "}>
