  ...
  return (
    <>
      ...
      <Layout title={section?.list_2?.title || "Tại sao nên học Ngôn ngữ Anh - Trường Đại học Lao động - Xã hội"}>
        <Card title={section?.list_2?.title_1 || "NHU CẦU NHÂN LỰC CAO "}>
        ...
        <Card title={section?.list_2?.title_2 || "PHÁT TRIỂN KỸ NĂNG MỀM"}>
        ...
        <Card title={section?.list_2?.title_3 || "CƠ HỘI THĂNG TIẾN VÀ PHÁT TRIỂN"}>
